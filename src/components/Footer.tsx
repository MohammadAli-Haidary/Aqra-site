        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-gray-400 text-xs">دنیای کتاب و دانش</p>
              </div>
            </div>
            <p className="text-gray-400 leading-relaxed mb-6">
              کتاب‌فروشی اقرأ با بیش از ۱۵ سال تجربه، بهترین کتاب‌ها را با مناسب‌ترین قیمت به شما ارائه می‌دهد.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#contact" className="text-gray-400 hover:text-amber-500 transition-colors flex items-center gap-2"><i className="fas fa-chevron-left text-xs"></i>تماس با ما</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-400 hover:text-amber-500 transition-colors flex items-center gap-2"><i className="fas fa-chevron-left text-xs"></i>کودک و نوجوان</a></li>
              <li><a href="#" className="text-gray-400 hover:text-amber-500 transition-colors flex items-center gap-2"><i className="fas fa-chevron-left text-xs"></i>علمی و آموزشی</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-400">تهران، خیابان انقلاب، پلاک ۱۲۳</span>
              </li>
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-gray-400">info@egra-book.ir</span>
              </li>
              <li className="flex items-center gap-3">
                <i className="fas fa-clock text-amber-500"></i>
                <span className="text-gray-400">شنبه تا پنجشنبه: ۹ تا ۲۱</span>
              </li>
            </ul>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-gray-400 text-sm">
              © ۱۴۰۳ کتاب‌فروشی اقرأ. تمامی حقوق محفوظ است.
            </p>
            <div className="flex gap-6">
              <a href="#" className="text-gray-400 hover:text-amber-500 text-sm transition-colors">قوانین و مقررات</a>
