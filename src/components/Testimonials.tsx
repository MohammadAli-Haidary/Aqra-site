...
const testimonials = [
  {
    name: 'علی محمدی',
    role: 'نویسنده',
    text: 'بهترین کتاب‌فروشی آنلاین که تا به حال باهاش کار کردم. ارسال سریع و کتاب‌های اصل.',
    rating: 5,
    avatar: '👨‍💼',
  },
  {
    name: 'مریم احمدی',
    role: 'دانشجو',
    text: 'قیمت‌ها عالی هستند و تنوع کتاب‌ها فوق‌العاده. حتماً به دوستام هم معرفی می‌کنم.',
    rating: 5,
    avatar: '👩‍🎓',
  },
  {
    name: 'رضا کریمی',
    role: 'استاد دانشگاه',
    text: 'پشتیبانی عالی و بسته‌بندی بی‌نقص. کتاب‌های تخصصی رو راحت پیدا می‌کنم.',
    rating: 4,
    avatar: '👨‍🏫',
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-white/70 text-lg max-w-2xl mx-auto">
            ببینید مشتریان ما درباره تجربه خریدشان چه می‌گویند
          </p>
        </div>
